...
do_install() {
	...
	cp  ${S}/etc/iqfiles/imx585_CMK-IMX585-PX1_FH34SRJ-30SCK0.json ${D}/etc/iqfiles/
	cp  ${S}/etc/iqfiles/imx678_FH34SRJ-30S_YG4118.json ${D}/etc/iqfiles/
	cp  ${S}/etc/iqfiles/os08a10_default_default.json ${D}/etc/iqfiles/
}
